...
namespace ScanIP
{
    public partial class Frm_Main : Form
    {
        ...
        private Thread myThread;           //创建线程对象
        string StartIPAddress = "";          //开始IP地址
        string EndIPAddress = "";            //结束IP地址
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (strIP.IndexOf(',') == -1) //字符中不包含‘，’
                {
                    if (listView1.Items.Count > 0)//判断列表中的数目是否大于0
                    {
                ...
                {
                    string[] strIPS = strIP.Split(',');//如果存在‘，’以，作为分割点
